...
recipeIngredients:
  ...
  - "17g Vital wheat gluten (Bob's Red Mill Preferred)"
  - "8g Olive oil"
  - "13g Salt"
...
recipeInstructions:
  - "Mix the dough: Add flour, salt, and vital wheat gluten into a stand mixer fitted with a dough hook attachment. Mix around the dry ingredients to combine. Add the olive oil and water (around 95 degrees F). Turn the mixer on medium-low for about 60 seconds. Scrape the sides down and give it another 60 seconds in the mixer. Put the dough into a bowl with a tightly fitted lid and let sit at room temperature (~70-74 degrees F) for 2 hours."
  - "Turn the dough out onto a floured surface. Split into two for two sheet pan pizzas, into three to make 14-16 inch pizzas, or into four to make 10-12 inch pizzas. Form the dough into tight balls iwth your hands, and place these into a well-floured 13x9 pan and cover with plastic wrap (or another large container with a tightly-fitted lid) to prevent moisture loss. Leave room between each to account for expansion. Place the dough balls into the fridge for 48-72 hours."
  ...
  - "Make the sauce: Using a stick blender (or traditional blender), blend the whole tomatoes and add a large grip of salt to taste. Place in a container for later."
...
The secret to this pizza dough lies in using [Vital Wheat Gluten](https://www.allrecipes.com/article/what-is-vital-wheat-gluten-how-to-use/) to boost the protein content of bread flour.
