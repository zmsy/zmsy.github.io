...
These tasks seem a little ridiculous and that's because they are, on purpose. They're not intended to measure how you would do as a software engineer in that organization. They're intended to prove, as quickly as possible, whether the cost of hiring you would bite the company in the behind later.

- Interviewers have an extremely short window during which to make a judgment.
- Since SWE pays well, it suffers from a glut of genuinely unqualified applicants. This occurs at all levels, but is drastically worse for anything below senior.
- These types of interviews have a wide, verified corpus of questions & answers and companies can draw from them without having to invest in their own interviewing materials.

There's been an arms race of non-FAANG (or whatever that acronym is nowadays) companies using the same tactics in order to raise their hiring bar arbitrarily.
