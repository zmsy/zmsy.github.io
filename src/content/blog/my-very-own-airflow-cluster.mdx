...
<InlineSvg file={'/src/svg/blog/my-very-own-airflow-cluster/airflow-diagram.svg'} className='large' />
...
<InlineSvg file={'/src/svg/blog/my-very-own-airflow-cluster/airflow-dag.svg'} />
