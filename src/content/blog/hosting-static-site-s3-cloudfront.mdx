...
import staticBucket from "@src/images/blog/hosting-static-site-s3-cloudfront/static_bucket.png";
import websiteOptions from "@src/images/blog/hosting-static-site-s3-cloudfront/website_options.png";
import bucketPermissions from "@src/images/blog/hosting-static-site-s3-cloudfront/bucket_permissions.png";
...
**Note:** If you use Terraform, the [cloudposse module for 'terraform-aws-cloudfront-s3-cdn'](https://github.com/cloudposse/terraform-aws-cloudfront-s3-cdn) will do all of this for you and then some. If you don't, read on.
...
<Image alt="" src={staticBucket} alt="Static Bucket Settings" />
...
<Image alt="" src={websiteOptions} alt="Website Options" />
...
<Image alt="" src={bucketPermissions} alt="S3 Bucket Policy Editor" />

<Admonition
  level="warning"
  text="This will make this bucket public! Do not keep sensitive data of any sort in it once you've made this change."
/>
